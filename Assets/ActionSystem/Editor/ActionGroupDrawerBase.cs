...
//            var sobj = new SerializedObject(ScriptableObject.CreateInstance(typeof(ActionGroup)));
...
//                    if (matrixProp != null)
//                    {
//                        ActionEditorUtility.LoadPrefab(prefabProp, instanceIDProp, matrixProp);
//                    }
//                    else
//                    {
...
//                if (obj != null)
//                {
//                    var matrixProp = itemProp.FindPropertyRelative("coordinate");
//                    ActionEditorUtility.SavePrefab(instanceIDPorp, matrixProp);
